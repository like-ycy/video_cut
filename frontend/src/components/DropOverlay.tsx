...
export default function DropOverlay({ active, replacing }: Props) {
  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-50 flex items-center justify-center bg-primary/10">
      <div
        className="flex flex-col items-center gap-3 rounded-lg border-2 border-dashed border-primary
                   bg-surface px-10 py-8 shadow-lg"
      >
        <div className="flex h-12 w-12 items-center justify-center rounded-full bg-primary-soft text-primary ">
          <Film className="h-6 w-6" />
        </div>
        <p className="text-sm font-medium text-foreground">松开鼠标即可载入视频</p>
